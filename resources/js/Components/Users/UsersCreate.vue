...
<div class="border-b border-gray-900/10 pb-12">
    <h2 class="text-base font-semibold leading-7 text-red-900">Create user</h2>
    ...
    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="sm:col-span-2">
            ...
            <div class="mt-1">
                ...
                <select id="permission" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" name="permission_id" v-model="form.permission_id">
